...
/**
 * Executes the Python GEE coastal erosion script.
 ...
 * @param {number} [threshold] - Optional shoreline retreat threshold (meters)
 * @returns {Promise<Object>} - Analysis results
 */
function runCoastalErosionCheck(
  regionGeoJson,
  regionId,
  credentialsPath,
  threshold
  ...
  return new Promise((resolve, reject) => {
    ...
    const scriptFilename = "coastal_erosion.py";
