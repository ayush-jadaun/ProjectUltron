...
const EnvironmentFloodingLayers = ({ children }) => {
	return (
		<div className="relative min-h-screen w-full overflow-hidden">
			...
			<div className="absolute inset-0 z-[-5] bg-gradient-to-b from-gray-700 via-gray-600 to-gray-500"></div>

			{/* Rain clouds */}
			<div className="absolute inset-0 z-[-4] pointer-events-none">
				{/* Large dark rain cloud */}
				<div className="absolute top-[5%] left-[15%]">
					<div className="w-20 h-10 sm:w-28 sm:h-14 bg-gray-600 rounded-full opacity-95 relative">
						<div className="absolute -top-4 left-4 w-14 h-14 sm:w-18 sm:h-18 bg-gray-500 rounded-full"></div>
						<div className="absolute -top-2 -right-1 w-12 h-12 sm:w-16 sm:h-16 bg-gray-400 rounded-full"></div>
						<div className="absolute top-0 left-10 w-10 h-10 sm:w-14 sm:h-14 bg-gray-500 rounded-full"></div>
					</div>
				</div>
				{/* Medium rain cloud */}
				<div className="absolute top-[12%] left-[60%] scale-90">
					<div className="w-20 h-10 sm:w-24 sm:h-12 bg-gray-500 rounded-full opacity-90 relative">
						<div className="absolute -top-3 left-3 w-12 h-12 sm:w-16 sm:h-16 bg-gray-400 rounded-full"></div>
						<div className="absolute -top-1 right-2 w-10 h-10 sm:w-12 sm:h-12 bg-gray-500 rounded-full"></div>
					</div>
				</div>
				{/* Small rain cloud */}
				<div className="absolute top-[3%] left-[35%] scale-60">
					<div className="w-16 h-8 bg-gray-400 rounded-full opacity-85 relative">
						<div className="absolute -top-3 left-3 w-10 h-10 bg-gray-500 rounded-full"></div>
						<div className="absolute top-0 left-8 w-8 h-8 bg-gray-400 rounded-full"></div>
					</div>
				</div>
			</div>
			...
			<div className="absolute inset-0 z-[-3] pointer-events-none">
				{Array.from({ length: 20 }).map((_, i) => (
					<div
						key={i}
						className="absolute bg-blue-200 opacity-70 w-0.5 h-8"
						style={{
