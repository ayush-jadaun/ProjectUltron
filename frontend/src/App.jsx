		...
		<div className="min-h-screen bg-gray-50">
				...
				<div className="bg-white rounded-lg shadow-lg p-6 max-w-4xl mx-auto">
					...
					<form onSubmit={handleSubmit} className="space-y-8">
						...
						<section>
							...
							<div className="mb-6 h-128 border rounded-lg overflow-hidden">
								{/* Map placeholder - would be replaced with actual Map component */}
								<div className="h-full bg-blue-50 flex items-center justify-center">
									<iframe
										src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d30773279.53444763!2d61.032955308692095!3d19.691161785276627!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30635ff06b92b791%3A0xd78c4fa1854213a6!2sIndia!5e0!3m2!1sen!2sin!4v1744995235464!5m2!1sen!2sin"
										width="100%"
										height="100%"
										allowFullscreen=""
										loading="lazy"
			...
			<footer className="mt-16 bg-gray-100 py-8 px-4">
				<div className="container mx-auto text-center text-gray-600">
					<p className="mb-4">
						&copy; 2025 EcoAlert - Environmental Monitoring System
					</p>
