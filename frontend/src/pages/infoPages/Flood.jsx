              ...
              >
                ...
                <div className="flex justify-between items-center border-t border-blue-200 pt-4">
                  <blockquote className="italic text-gray-700 pl-4 border-l-4 border-blue-300">
                    "The 2023 floods demonstrated how community preparedness can
                    dramatically reduce the impact of natural disasters."
                    <footer className="text-sm font-medium text-blue-700 mt-1">
                      — Dr. Sarah Miller, NOAA Disaster Response Team
                    </footer>
                  </blockquote>
