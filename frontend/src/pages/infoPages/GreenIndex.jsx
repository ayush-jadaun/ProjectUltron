            ...
            <section className="border border-green-200 rounded-xl overflow-hidden bg-gradient-to-br from-green-50 to-white">
              ...
              >
                ...
                <div className="flex justify-between items-center border-t border-green-200 pt-4">
                  <blockquote className="italic text-gray-700 pl-4 border-l-4 border-green-300">
                    "When we combine indigenous wisdom with modern technology
                    and sustainable economics, we create conservation models
                    that truly work."
                    <footer className="text-sm font-medium text-green-700 mt-1">
                      — Raoni Metuktire, Indigenous Leader and Terra Verde
                      Project Advisor
                    </footer>
                  </blockquote>
                  <button className="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg shadow-sm transition">
                    View Project
                  </button>
                </div>
              </div>
